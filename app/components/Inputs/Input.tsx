  ...
  return (
    <div className="w-full relative">
      <input
        ...
        placeholder=" "
        type={type}
        className={`peer w-full p-3 pt-6 pl-4 font-light bg-neutral-100 border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed relative
